...
Admin_Start_b6 = KeyboardButton(text='Заработок')
Admin_Start_kb.add(Admin_Start_b1, Admin_Start_b2, Admin_Start_b3, Admin_Start_b4, Admin_Start_b5, Admin_Start_b6)
